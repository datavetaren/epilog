...
private:
    ...
    interp::remote_return_t execute_at_node(term query, term else_do, interp::interpreter_base &query_interp, const std::string &where, interp::remote_execute_mode mode, size_t timeout);
    interp::remote_return_t continue_at_node(term query, term else_do, interp::interpreter_base &query_interp, const std::string &where, interp::remote_execute_mode mode, size_t timeout);
    bool delete_instance_at_node(term_env &query_src, const std::string &where);

    interp::remote_return_t execute_at_wallet(term query, term else_do, interp::interpreter_base &query_interp, const std::string &where, interp::remote_execute_mode mode, size_t timeout);
    interp::remote_return_t continue_at_wallet(term query, term else_do, interp::interpreter_base &query_interp, const std::string &where, interp::remote_execute_mode mode, size_t timeout);
