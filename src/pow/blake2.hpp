...
/*
   ...
   https://blake2.net.
*/
#ifndef _pow_BLAKE2_H
#define _pow_BLAKE2_H

// Intentional code duplication. I don't want a dependency to common/
// as I want the proof-of-work code to be completely isolated from
