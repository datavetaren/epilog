...
private:
    ...
    using utime = epilog::common::utime;
    using term = epilog::common::term;
    using term_env = epilog::common::term_env;
...
public:
    ...
    static const unsigned short DEFAULT_PORT = epilog::terminal::terminal::DEFAULT_PORT;
    static const size_t MAX_BUFFER_SIZE = epilog::terminal::terminal::MAX_BUFFER_SIZE;
