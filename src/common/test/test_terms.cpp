...
static void test_heap_simple()
{
    ...
    auto big3 = h.new_big( 128 ); // 128 bits
    unsigned char bytes[16] = { 0x10, 0x20, 0x30, 0x40, 0x50, 0x60, 0x70, 0x80,
				0x90, 0xa0, 0xb0, 0xc0, 0xd0, 0xe0, 0xf0, 0xff};
    h.set_big(big3, bytes, sizeof(bytes));
